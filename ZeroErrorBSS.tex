...
\section{Introduction {\color{red}\textbf{Check where to Insert Sources!}}}	\label{sec:Introduction}
	...
	can be found in \sdummy, a patent held by the \emph{Siemens AG}. For cyber-physical networks, the method can be extended as far as to implement a virtual copy of the full network itself, which may then be used e.g. for the generation
