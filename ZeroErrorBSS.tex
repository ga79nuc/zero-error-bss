...
---
	...
	\begin{figure}\linespread{1}
		...
		\end{tikzpicture}
		\caption{Schematics of the remote state estimation setup considered throughout this article.% 
					%Aside from the entanglement source, the setup... 
					The setup is identical to the one introduced in \sdummy.}
...
\section{Formal Description of the Remote State Estimation Setup}
	...
	%Aside from the entanglement source, the system is identical...
