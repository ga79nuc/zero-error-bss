...
\begin{abstract}
	...
	decision problem given the plant's and DMC's characteristics. \noteholger{Blum-Shub-Smale machines are a promising candidate for a universal model of real number processing hardware, comparable
	to the Turing machine in the digital domain. Recently, we can observe an increased interest in research and development towards real number and/or analog computing hardware, usually
...
\section{Introduction}	\label{sec:Introduction}
	\IEEEPARstart{R}{emote} state estimation via noisy communication channels is a prominent problem in control theory \sdummy. 
	\noteholger{The problem involves both conotrol and communications. In praticular, as we will see in the following, the communications part is essential.}  
	...
	\end{figure}
	\noteholger{The key applications of this problem range from robotics over autonomous driving to general remote controlled systems \sdummy. However, there exist fundamental 
	limits to the capabilites of autonomous systems and computer aided design tools, as has been shown on several in several instances \sdummy. These fundamental limits essentially
	...
	\noteholger{Generally, this is known as the co-design of control and communication. In this context, the problem of remote state estimation via noisy channels is particularly interesting,
	...
	dynamic systems is actually possible, arises naturally. \noteholger{Thus, the question arises whether digital hardware is the proper hardware platform for decision making of this kind. It has been shown
	...
	\emph{Blum-Shub-Smale (BSS) machines} as the underlying machine model. \noteholger{Potentially, Blum-Shub-Smale machines yield a mathematical description of a universal analog computer.
	...
	\noteholger{As already stated before the co-design of control and communication is of particular interest in this context, since the criterion for control performance, which is
...
\section{Summary and Conclusion}	\label{sec:Conclusion}
	...
	\noteholger{The problem of remote state estimation via noisy channels is an explicite example of control and communications co-design. The criterion imposed on the control performance
